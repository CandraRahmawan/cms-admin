            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <!--/.box-header -->
                        <div class = "box-body">
                            <table id = "list_guestbook" class = "table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <?php
...
<script type="text/javascript">
    $(function () {
        $('#list_guestbook').DataTable({
            "ordering": false,
            "processing": true,
            "serverSide": true,
            "iDisplayLength": 25,
            "ajax": "<?php echo $this->Url->build(['plugin' => 'Message', 'controller' => 'Guestbook', 'action' => 'serverSide', '_ext' => 'html']); ?>",
