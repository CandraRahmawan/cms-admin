                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            ?>
                            <h3 class = "box-title"><button class = "btn btn-block btn-primary" type = "button" onclick = "location.href = '<?php echo $this->Url->build(['plugin' => 'Images', 'controller' => 'Images', 'action' => 'form', '_ext' => 'html']); ?>'"><i class = "fa fa-fw fa-plus"></i> Upload Images</button></h3>
                        </div>
                        <!--/.box-header -->
                        <div class = "box-body">
...
<script type="text/javascript">
    $(function () {
        $('#list_slider').DataTable({
            ...
            "serverSide": true,
            "iDisplayLength": 25,
            "ajax": "<?php echo $this->Url->build(['plugin' => 'Images', 'controller' => 'Images', 'action' => 'serverSide', '_ext' => 'html']); ?>",
