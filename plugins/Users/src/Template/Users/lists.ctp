                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            ?>
                            <h3 class = "box-title"><button class = "btn btn-block btn-primary" type = "button" onclick = "location.href = '<?php echo $this->Url->build(['plugin' => 'Users', 'controller' => 'Users', 'action' => 'add', '_ext' => 'html']); ?>'"><i class = "fa fa-fw fa-user-plus"></i> Add User</button></h3>
                        </div>
                        <div class = "box-body">
...
<script type="text/javascript">
    $(function () {
        $('#list_users').DataTable({
            ...
            "serverSide": true,
            "iDisplayLength": 25,
            "ajax": "<?php echo $this->Url->build(['plugin' => 'Users', 'controller' => 'Users', 'action' => 'serverSide', '_ext' => 'html']); ?>",
            initComplete: function () {
                var api = this.api();
                $('#list_users_filter input')
                        .off('.DT')
