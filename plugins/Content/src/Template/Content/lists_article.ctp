                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            ?>
                            <h3 class = "box-title"><button class = "btn btn-block btn-primary" type = "button" onclick = "location.href = '<?php echo $this->Url->build(['plugin' => 'Content', 'controller' => 'Content', 'action' => 'formArticle', '_ext' => 'html']); ?>'"><i class = "fa fa-fw fa-plus"></i> Add Article</button></h3>
                        </div>
                        <div class = "box-body">
...
<script type="text/javascript">
    $(function () {
        $('#list_content').DataTable({
            ...
            "serverSide": true,
            "iDisplayLength": 25,
            "ajax": "<?php echo $this->Url->build(['plugin' => 'Content', 'controller' => 'Content', 'action' => 'serverSide']); ?>/article",
