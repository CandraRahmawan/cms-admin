                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Why Choose Us Section</h3>
                        </div>
                        <div class="box-body">
...
<script>
    ...
    function addSection() {
        ...
        formGroup += '</div></div>';
        formGroup += '<div class="form-group">';
        formGroup += '<label for="name" class="col-sm-3 control-label">Icon</label>';
        formGroup += '<div class="col-sm-9">';
        ...
        formGroup += ' <button type="button" class="btn btn-primary" data-key="image[' + countSection + ']" data-toggle="modal" data-target="#modalListImage">Browse Icon</button>';
