                          ...
                          ?>
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="hidden" name="image" value="<?= $value_2; ?>"/>
                                        <img src="<?= $value_2; ?>" id=image
...
if ($this->request->is('post')) {
  ...
  $value_2 = empty($data['image']) ? '-' : $data['image'];;
  if (!empty($id)) {
    $connection->update('plugins_detail', ['value_1' => $value_1, 'value_2' => $value_2, 'updated_date' => date('Y-m-d H:i:s')], ['plugin_detail_id' => $id]);
  } else {
