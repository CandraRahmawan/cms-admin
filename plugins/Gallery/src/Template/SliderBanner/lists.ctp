                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            ?>
                            <h3 class = "box-title"><button class = "btn btn-block btn-primary" type = "button" onclick = "location.href = '<?php echo $this->Url->build(['plugin' => 'Gallery', 'controller' => 'SliderBanner', 'action' => 'form', '_ext' => 'html']); ?>'"><i class = "fa fa-fw fa-plus"></i> Add Slider Banner</button></h3>
                        </div>
                        <!--/.box-header -->
                        <div class = "box-body">
                            <table id = "list_slider" class = "table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <?php
...
<script type="text/javascript">
    $(function () {
        $('#list_slider').DataTable({
            "ordering": false,
            "processing": true,
            "serverSide": true,
            "iDisplayLength": 25,
            "ajax": "<?php echo $this->Url->build(['plugin' => 'Gallery', 'controller' => 'SliderBanner', 'action' => 'serverSide', '_ext' => 'html']); ?>",
            initComplete: function () {
                var api = this.api();
                $('#list_slider_filter input')
                        .off('.DT')
