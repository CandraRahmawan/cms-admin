                ...
                <div class="col-md-8">
                    <div class="box box-primary">
                      ...
                      if ($sliderBanner['path'] != '')
                        $path_image = '"' . $this->request->webroot . $sliderBanner['path'] . '"';
                      else
                        $path_image = 'null';
                      $explode_path_image = explode(DS, $path_image);
                      $img_name = end($explode_path_image);
                      ?>
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="title" name="title"
                                           value="<?php echo $sliderBanner['title']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="description" name="description"
                                           value="<?php echo $sliderBanner['description']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="link" name="link"
                                           value="<?php echo $sliderBanner['link']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
