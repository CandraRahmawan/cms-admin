...
CREATE TABLE `themes_setting` (
  ...
  `category` enum('Slider Banner','Page','Section','Plugin','MultiSelect','isActive') DEFAULT NULL,
...
INSERT INTO `themes_setting` VALUES (1,'area_coverage','Area Coverage Plugin','plugin','','Y','embed','Plugin'),(1,'area_coverage_title','Area Coverage Title','plugin','','Y','text',NULL),(1,'company_title','Company Title','company','','Y','text',NULL),(1,'contact_email','Contact Email','contact','','Y','text',NULL),(1,'contact_phone','Contact Phone','contact','','Y','text',NULL),(1,'contact_whatsapp','Contact Whatsapp','contact','','Y','text',NULL),(1,'footer_address','Footer Address','footer','','Y','text',NULL),(1,'footer_address_title','Footer Address Title','heading','','Y','text',NULL),(1,'footer_copyright','Footer CopyRight','footer','','Y','text',NULL),(1,'footer_title_blog','Footer Artikel Title','heading','','Y','text',NULL),(1,'footer_title_contact','Footer Contact Title','heading','','Y','text',NULL),(1,'hide_menu_sidebar','Hide Menu Sidebar Content Management',NULL,'[]','Y','text','MultiSelect'),(1,'image_logo','Image Logo','image','','Y','image',NULL),(1,'menu_header','Menu Header',NULL,'1','Y','embed','Page'),(1,'path_url_admin','Path Url Admin',NULL,'','Y','text',NULL),(1,'section_1','Section Welcome Homepage','section','','Y','embed','Section'),(1,'section_1_title','Title Welcome Homepage','heading','','Y','text',NULL),(1,'service_page','Service Page Plugin','plugin','','Y','embed','Plugin'),(1,'service_page_title','Service Page Title','plugin','','Y','text',NULL),(1,'top_image_carousel','Homepage Image Banner','image','','Y','embed','Slider Banner'),(1,'why_choose_us','Why Choose Us Plugin','plugin','','Y','embed','Plugin'),(1,'why_choose_us_title','Why Choose Us Title','plugin','','Y','text',NULL),(2,'captcha_secret_key','Captcha Secret Key',NULL,'','Y','text',NULL),(2,'captcha_site_key','Captcha Site Key',NULL,'','Y','text',NULL),(2,'company_title','Company Title','company','','Y','text',NULL),(2,'contact_email_send_to','Contact Email Send To','contact','[]','Y','text','MultiSelect'),(2,'contact_page','Contact Page','plugin','','Y','embed','Plugin'),(2,'email','Email','contact','','Y','text',NULL),(2,'facebook','Facebook Link','social_media','','Y','text',NULL),(2,'featured_category_product','Featured Category Product','plugin','','Y','embed','Plugin'),(2,'featured_top_image_carousel','Featured Homepage Top Image Carousel',NULL,'','Y','embed','Slider Banner'),(2,'filename_product_template','Filename Product Template List','template','[]','Y','text','MultiSelect'),(2,'filename_product_template_note','Filename Product Template Note','template','','Y','text',NULL),(2,'hide_menu_sidebar','Hide Menu Sidebar Content Management',NULL,'[]','Y','text','MultiSelect'),(2,'images_upload_note','Images Upload Note',NULL,'','Y','text',NULL),(2,'image_logo','Image Logo','image','','Y','image',NULL),(2,'instagram','Instagram Link','social_media','','Y','text',NULL),(2,'is_email_send_active','Activate Send Email','contact','','Y','text','isActive'),(2,'menu_footer','Menu Footer',NULL,'','Y','embed','Page'),(2,'menu_header','Menu Header',NULL,'','Y','embed','Page'),(2,'our_story_page','Our Story Page','plugin','','Y','embed','Plugin'),(2,'phone_number','Phone Number','contact','','Y','text',NULL),(2,'product_category_page','Product Category Page Plugin','plugin','','Y','embed','Plugin'),(2,'section_1','Homepage Section 1','plugin','','Y','embed','Plugin'),(2,'section_2','Homepage Section 2','plugin','','Y','embed','Plugin'),(2,'section_3','Homepage Section 3','plugin','','Y','embed','Plugin'),(2,'section_4','Homepage Section 4','plugin','','Y','embed','Plugin'),(2,'service_centre','Service Centre List','plugin','','Y','embed','Plugin'),(2,'shopee','Shopee Link','social_media','','Y','text',NULL),(2,'tokopedia','Tokopedia Link','social_media','','Y','text',NULL),(2,'top_image_carousel','Homepage Top Image Carousel',NULL,'','Y','embed','Slider Banner'),(2,'warranty_information_page','Warranty Information Page','plugin','','Y','embed','Plugin'),(2,'whatsapp_number','WhatsApp Number','contact','','Y','text',NULL),(2,'where_to_buy_page','Where to Buy Page','plugin','','Y','embed','Plugin'),(2,'youtube_review','Youtube Review Plugin','plugin','','Y','embed','Plugin');
...
-- Dump completed on 2020-04-08 21:47:10
