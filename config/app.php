...
return [
    ...
    'App' => [
        ...
        'baseUrlWeb' => $protocol . $_SERVER["SERVER_NAME"] . env('ADMIN_PATH_URL'),
        'baseUrlFrontEnd' => $protocol . $_SERVER["SERVER_NAME"] . env('WEB_PATH_URL'),
        'fullBaseUrl' => false,
        'imageBaseUrl' => 'img/',
        'cssBaseUrl' => 'css/',
        'jsBaseUrl' => 'js/',
     ...
     */
    'Error' => [
        'errorLevel' => E_ALL & ~E_USER_DEPRECATED & E_STRICT,
    ...
    'Email' => [
        'default' => [
            'transport' => 'default',
            'from' => env('EMAIL_USERNAME', 'localhost'),
            //'charset' => 'utf-8',
            //'headerCharset' => 'utf-8',
        ],
    ],
    ...
    'Log' => [
        ...
        'error' => [
            ...
            'scopes' => false,
            'levels' => ['warning', 'error', 'critical', 'alert', 'emergency', 'notice'],
        ],
