...
class Category extends Entity
{
    ...
    {
        return !empty($this->_properties['category_id']) ? "<a href=\"" . $this->request . "form-category.html?category_id=" . $this->_properties['category_id'] . "\"><i class=\"fa fa-fw fa-edit\"></i> Update </a>" : "";
    }
